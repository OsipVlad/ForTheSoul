...
namespace ConsoleApp1
{
    internal class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            #region Перегрузка функции. Увеличение одномерного\двумерного массива
        ...
        static int[] Resize(int[] array, int size)//Функция увеличивающая массив
        {
        ...
        static int[,] Resize(int[,] array, int x, int y)//функция увеличивающая двумерный массив 
        {
